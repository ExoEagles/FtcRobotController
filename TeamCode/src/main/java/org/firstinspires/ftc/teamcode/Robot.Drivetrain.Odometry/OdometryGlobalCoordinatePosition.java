...
public class OdometryGlobalCoordinatePosition implements Runnable{
    ...
    private double leftChange = 0, rightChange = 0, changeInRobotOrientation = 0;
    ...
    public double globalLeftChange(){ return leftChange; }
    public double globalRightChange(){ return rightChange; }
    public double globalChangeInOrientation(){ return changeInRobotOrientation; }
    /**
