 ...
 */
@TeleOp(name = "BlankTester", group = "Calibration")
public class MotorTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(((getXAngle() < 90)||(getXAngle() < -90)) && opModeIsActive()){
        ...
        double angle = Math.abs(getXAngle());
       ...
       */
        ...
        horizontalTickOffset = horizontal.getCurrentPosition()/Math.toRadians(Math.abs(getXAngle()));
        
        //7400 code
    //    double parrallelEncodersAvg = ((verticalLeft.getCurrentPosition()+verticalRight.getCurrentPosition())/2);
      //  double parrallelCountsRadius = ((parrallelEncodersAvg*360)/angle);
    //    double parrallelDiameterInches = (parrallelCountsRadius/COUNTS_PER_INCH)*2;
     //   double horizontalCountsRadius = ((horizontal.getCurrentPosition()*360)/angle);
    //    double horizontalRadiusInches = (horizontalCountsRadius/COUNTS_PER_INCH);        
    ...
    //        telemetry.addData("7400parrallelRadiusInches",parrallelDiameterInches);
    //        telemetry.addData("7400horizontalRadiusInches",horizontalRadiusInches);           
            //Update values
            telemetry.update();
        }
    }
